...
public struct Moon: Equatable {
    ...
    init(julianDay: Double, sun: Coords, location: Coords) {
        ...
        apparentAngle = atan2(cos(sun.latitude)
    ...
    init(phase: Phase = .new, fraction: Int = 0, angle: Double = 0, inclination: Double = 0, apparentAngle: Double = 0) {
        self.phase = phase
